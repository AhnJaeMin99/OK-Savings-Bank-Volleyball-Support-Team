    ...
    <div className="fixed inset-0 w-screen h-screen overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center w-full h-full">
        <div className="max-w-md w-full mx-auto px-8 py-12 flex flex-col items-center shadow-2xl rounded-3xl border border-white/70 bg-white/95 backdrop-blur-[16px] drop-shadow-2xl">
          ...
          {/* 중앙 타이틀 한 줄, 읏맨 설명 */}
          <h1 className="text-3xl md:text-5xl font-bold tracking-tight mb-2 text-center">OK저축은행 읏맨</h1>
          <p className="text-sm md:text-base text-gray-400 font-korean mb-8 text-center">읏맨은 OK저축은행의 공식 마스코트입니다.</p>
          {/* 버튼 그룹 */}
