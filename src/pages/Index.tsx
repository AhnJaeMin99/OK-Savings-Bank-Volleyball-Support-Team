...
const Index = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-orange-600 via-red-600 to-orange-800">
      {/* 역동적인 배경 패턴 */}
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-r from-orange-500/20 via-red-500/30 to-orange-600/20"></div>
        <div className="absolute top-10 left-10 w-32 h-32 bg-yellow-400/20 rounded-full blur-xl animate-pulse"></div>
        <div className="absolute bottom-20 right-20 w-48 h-48 bg-orange-400/30 rounded-full blur-2xl animate-bounce"></div>
        <div className="absolute top-1/2 left-1/4 w-20 h-20 bg-red-400/40 rounded-full blur-lg animate-ping"></div>
      </div>

      {/* 네비게이션 헤더 - 스포츠 느낌 강화 */}
      <header className="relative z-20 backdrop-blur-md bg-black/30 border-b-4 border-orange-500/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center space-x-4">
              <div className="bg-gradient-to-br from-orange-500 via-red-600 to-orange-700 rounded-full p-3 shadow-2xl border-4 border-yellow-400/60">
            ...
            <div className="flex space-x-4">
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-yellow-500 via-orange-500 to-red-600 hover:from-yellow-600 hover:via-orange-600 hover:to-red-700 text-black text-sm px-8 py-3 font-korean font-black transition-all duration-300 hover:scale-110 hover:shadow-2xl shadow-orange-500/80 border-2 border-yellow-400"
              >
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-5rem)] px-4 text-center">
        {/* 상단 뱃지 - 승리의 정신 */}
        <Badge className="mb-10 bg-gradient-to-r from-yellow-500 via-orange-600 to-red-600 hover:from-yellow-600 hover:via-orange-700 hover:to-red-700 text-black px-12 py-4 text-base rounded-full shadow-2xl backdrop-blur-sm font-korean font-black transition-all duration-500 hover:scale-110 border-4 border-yellow-400/80">
        ...
        <div className="flex items-center justify-center mb-10 transform hover:scale-105 transition-transform duration-300">
          ...
          <div className="flex space-x-2">
            ...
            <Volleyball className="w-10 h-10 text-orange-400 animate-bounce" />
          </div>
        </div>
        ...
        <p className="text-xl md:text-2xl text-yellow-100 mb-16 max-w-4xl leading-relaxed font-korean font-bold drop-shadow-lg">
          ...
          <span className="text-yellow-300 font-black">OK금융그룹 옥맨 배구단</span>의 열정적인 순간들
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-8 mb-20">
          <Button 
            onClick={() => navigate('/signup')}
            className="group bg-gradient-to-r from-yellow-500 via-orange-600 to-red-700 hover:from-yellow-600 hover:via-orange-700 hover:to-red-800 text-black text-xl px-16 py-6 rounded-2xl shadow-2xl font-korean font-black transition-all duration-500 hover:scale-125 hover:shadow-yellow-500/80 transform hover:-translate-y-2 relative overflow-hidden border-4 border-yellow-400"
          >
            ...
            <span className="relative z-10">옥맨 도전하기</span>
        ...
        <div className="w-full max-w-7xl">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {/* 일정 조회 카드 */}
            <Card className="group backdrop-blur-md bg-gradient-to-br from-orange-500/20 via-red-500/15 to-orange-600/20 border-4 border-yellow-400/50 hover:border-yellow-400 hover:bg-gradient-to-br hover:from-orange-400/30 hover:via-red-400/25 hover:to-orange-500/30 transition-all duration-500 hover:scale-110 hover:shadow-2xl hover:shadow-orange-500/40 transform hover:-translate-y-4">
            ...
            {/* 신청 관리 카드 */}
            <Card className="group backdrop-blur-md bg-gradient-to-br from-orange-500/20 via-red-500/15 to-orange-600/20 border-4 border-yellow-400/50 hover:border-yellow-400 hover:bg-gradient-to-br hover:from-orange-400/30 hover:via-red-400/25 hover:to-orange-500/30 transition-all duration-500 hover:scale-110 hover:shadow-2xl hover:shadow-red-500/40 transform hover:-translate-y-4">
              <CardHeader className="text-center">
                <div className="bg-gradient-to-br from-red-600 to-orange-700 rounded-full w-24 h-24 flex items-center justify-center mx-auto mb-8 shadow-2xl group-hover:scale-125 transition-transform duration-500 border-4 border-yellow-400/60">
              ...
              <CardContent>
                <CardDescription className="text-center text-white font-korean font-bold text-base">
                  안전한 이메일 인증으로<br />옥맨 전용 플랫폼 접근
                </CardDescription>
              </CardContent>
            </Card>

            {/* 결과 시각화 카드 */}
            <Card className="group backdrop-blur-md bg-gradient-to-br from-orange-500/20 via-red-500/15 to-orange-600/20 border-4 border-yellow-400/50 hover:border-yellow-400 hover:bg-gradient-to-br hover:from-orange-400/30 hover:via-red-400/25 hover:to-orange-500/30 transition-all duration-500 hover:scale-110 hover:shadow-2xl hover:shadow-green-500/40 transform hover:-translate-y-4">
              <CardHeader className="text-center">
      ...
      {/* 푸터 - 팀 정신 반영 */}
      <footer className="relative z-10 backdrop-blur-md bg-black/40 text-white py-10 border-t-4 border-orange-500/60">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <div className="flex items-center justify-center space-x-4 mb-6">
            <div className="bg-gradient-to-br from-orange-500 via-red-600 to-orange-700 rounded-full p-3 shadow-2xl border-4 border-yellow-400/60">
              <Volleyball className="h-6 w-6 text-white animate-pulse" />
            </div>
            <span className="text-xl font-black font-korean text-yellow-300">OK금융그룹 옥맨 배구단</span>
